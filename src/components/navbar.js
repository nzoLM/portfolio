...
export function Navbar(){
    return (
        <nav className="w-full">
            <div className='flex flex-col sm:flex-row relative items-center p-5 bg-linear-to-b from-[#A79EA1]/20 to-transparent gap-5 w-full text-white'>
